...
utilisant LlamaIndex pour la recherche intelligente dans un cours de droit administratif.
"""
...
class MarkdownDocumentProcessor:
    """
    Processeur de documents Markdown avec découpage sémantique et indexation.
    """
    ...
    def _setup_llamaindex(self):
        """Configure LlamaIndex avec les modèles OpenAI."""
        ...
        logger.info("Configuration LlamaIndex terminée")
...
def main():
    ...
    try:
        ...
        print("\n" + "="*80)
        print("🔍 EXEMPLES DE RECHERCHE SÉMANTIQUE")
        print("="*80)
